...
module ActionView
  ...
  module Helpers #:nodoc:
    ...
    module AssetTagHelper
      ...
      # path, a file, or an Pro Active Storage attachment.
      #
      # ==== Options
      #
      ...
      #
      # Pro Active Storage (images that are uploaded by the users of your app):
      #
      #   image_tag(user.avatar)
      #   # => <img src="/rails/pro_active_storage/blobs/.../tiger.jpg" />
      #   image_tag(user.avatar.variant(resize_to_fit: [100, 100]))
      #   # => <img src="/rails/pro_active_storage/variants/.../tiger.jpg" />
      #   image_tag(user.avatar.variant(resize_to_fit: [100, 100]), size: '100')
      #   # => <img width="100" height="100" src="/rails/pro_active_storage/variants/.../tiger.jpg" />
