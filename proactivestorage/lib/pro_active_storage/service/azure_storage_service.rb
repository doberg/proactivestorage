...
module ProActiveStorage
  # Wraps the Microsoft Azure Storage Blob Service as an Pro Active Storage service.
  # See ProActiveStorage::Service for the generic API documentation that applies to all services.
