...
class ProActiveStorage::Filename::ParametersTest < ActiveSupport::TestCase
  test "parameterizing a Latin filename" do
    filename = ProActiveStorage::Filename.new("racecar.jpg")
  ...
  test "parameterizing a Latin filename with accented characters" do
    filename = ProActiveStorage::Filename.new("råcëçâr.jpg")
  ...
  test "parameterizing a non-Latin filename" do
    filename = ProActiveStorage::Filename.new("автомобиль.jpg")
