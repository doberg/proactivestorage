...
class ProActiveStorage::VariantTest < ActiveSupport::TestCase
  ...
  test "monochrome with default variant_processor" do
    begin
      ProActiveStorage.variant_processor = nil
      ...
      ProActiveStorage.variant_processor = :mini_magick
    end
  end
  ...
  test "variation of invariable blob" do
    assert_raises ProActiveStorage::InvariableError do
  ...
  test "works for vips processor" do
    begin
      ProActiveStorage.variant_processor = :vips
      blob = create_file_blob(filename: "racecar.jpg")
