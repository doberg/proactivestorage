  ...
  module Generators
    class AppBase < Base # :nodoc:
      ...
      def self.add_shared_options_for(name)
        ...
        class_option :skip_pro_active_storage, type: :boolean, default: false,
                                           desc: "Skip Pro Active Storage files"
    ...
    private
      ...
      def skip_pro_active_storage? # :doc:
        options[:skip_pro_active_storage] || options[:skip_active_record]
      end
