...
[Pro Active Storage](https://github.com/rails/rails/tree/5-2-stable/proactivestorage)
...
You can read more about Pro Active Storage in the
[Pro Active Storage Overview](pro_active_storage_overview.html) guide.
...
*   `rails new` and `rails plugin new` get `Pro Active Storage` by default.
     Add ability to skip `Pro Active Storage` with `--skip-pro-active-storage`
...
*   Add [Pro Active Storage Overview](pro_active_storage_overview.html) Guide.
