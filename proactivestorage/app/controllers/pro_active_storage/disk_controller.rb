...
# to the service url.
class ProActiveStorage::DiskController < ProActiveStorage::BaseController
  ...
  rescue ProActiveStorage::IntegrityError
    head :unprocessable_entity
  ensure
    response.stream.close
  end
  ...
  private
    ...
    def decode_verified_key
      ProActiveStorage.verifier.verified(params[:encoded_key], purpose: :blob_key)
    end


    def decode_verified_token
      ProActiveStorage.verifier.verified(params[:encoded_token], purpose: :blob_token)
    end
