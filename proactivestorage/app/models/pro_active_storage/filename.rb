...
# A Filename instance is returned by ProActiveStorage::Blob#filename, and is comparable so it can be used for sorting.
class ProActiveStorage::Filename
  require_dependency "pro_active_storage/filename/parameters"

  include Comparable

  class << self
    # Returns a Filename instance based on the given filename. If the filename is a Filename, it is
    # returned unmodified. If it is a String, it is passed to ProActiveStorage::Filename.new.
    def wrap(filename)
  ...
  #
  #   ProActiveStorage::Filename.new("racecar.jpg").base # => "racecar"
  #   ProActiveStorage::Filename.new("racecar").base     # => "racecar"
  #   ProActiveStorage::Filename.new(".gitignore").base  # => ".gitignore"
  def base
  ...
  #
  #   ProActiveStorage::Filename.new("racecar.jpg").extension_with_delimiter # => ".jpg"
  #   ProActiveStorage::Filename.new("racecar").extension_with_delimiter     # => ""
  #   ProActiveStorage::Filename.new(".gitignore").extension_with_delimiter  # => ""
  ...
  #
  #   ProActiveStorage::Filename.new("racecar.jpg").extension_without_delimiter # => "jpg"
  #   ProActiveStorage::Filename.new("racecar").extension_without_delimiter     # => ""
  #   ProActiveStorage::Filename.new(".gitignore").extension_without_delimiter  # => ""
  ...
  #
  #   ProActiveStorage::Filename.new("foo:bar.jpg").sanitized # => "foo-bar.jpg"
  #   ProActiveStorage::Filename.new("foo/bar.jpg").sanitized # => "foo-bar.jpg"
  #
