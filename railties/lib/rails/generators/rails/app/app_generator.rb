  ...
  class AppBuilder
    ...
    def config
      ...
      inside "config" do
        ...
        template "storage.yml" unless skip_pro_active_storage?
    ...
    def config_when_updating
      ...
      pro_active_storage_config_exist    = File.exist?("config/storage.yml")
      ...
      if !skip_pro_active_storage? && !pro_active_storage_config_exist
  ...
  module Generators
    ...
    class AppGenerator < AppBase # :nodoc:
      ...
      def create_storage_files
        build(:storage) unless skip_pro_active_storage?
      end
