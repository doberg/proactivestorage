...
class ProActiveStorage::RepresentationsControllerWithVariantsTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "showing variant inline" do
    get rails_blob_representation_url(
      ...
      variation_key: ProActiveStorage::Variation.encode(resize: "100x100"))
...
class ProActiveStorage::RepresentationsControllerWithPreviewsTest < ActionDispatch::IntegrationTest
  setup do
