...
class ProActiveStorage::Previewer::PopplerPDFPreviewerTest < ActiveSupport::TestCase
  setup do
    @blob = create_file_blob(filename: "report.pdf", content_type: "application/pdf")
  end

  test "previewing a PDF document" do
    ProActiveStorage::Previewer::PopplerPDFPreviewer.new(@blob).preview do |attachable|
