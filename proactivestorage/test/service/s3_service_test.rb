...
if SERVICE_CONFIGURATIONS[:s3]
  class ProActiveStorage::Service::S3ServiceTest < ActiveSupport::TestCase
    SERVICE = ProActiveStorage::Service.configure(:s3, SERVICE_CONFIGURATIONS)
    ...
    test "uploading with server-side encryption" do
      ...
      service = ProActiveStorage::Service.configure(:s3, config)
