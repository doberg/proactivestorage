  ...
  module Downloading
    def self.included(klass)
      ActiveSupport::Deprecation.warn <<~MESSAGE.squish, caller_locations(2)
        ProActiveStorage::Downloading is deprecated and will be removed in Pro Active Storage 6.1.
        Use ProActiveStorage::Blob#open instead.
      MESSAGE
    end
    ...
    private
      ...
      def open_tempfile_for_blob
        tempfile = Tempfile.open([ "ProActiveStorage", blob.filename.extension_with_delimiter ], tempdir)
