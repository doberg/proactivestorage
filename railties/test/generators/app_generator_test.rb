...
class AppGeneratorTest < Rails::Generators::TestCase
  ...
  def test_gem_for_pro_active_storage
    run_generator
    assert_file "Gemfile", /^# gem 'image_processing'/
  end

  def test_gem_for_pro_active_storage_when_skip_pro_active_storage_is_given
    run_generator [destination_root, "--skip-pro-active-storage"]

    assert_no_gem "image_processing"
  end

  def test_app_update_does_not_generate_pro_active_storage_contents_when_skip_pro_active_storage_is_given
    app_root = File.join(destination_root, "myapp")
    run_generator [app_root, "--skip-pro-active-storage"]
  ...
  def test_app_update_does_not_generate_pro_active_storage_contents_when_skip_active_record_is_given
    app_root = File.join(destination_root, "myapp")
