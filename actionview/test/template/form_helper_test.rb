...
class FormHelperTest < ActionView::TestCase
  ...
  class WithProActiveStorageRoutesControllers < ActionController::Base
    test_routes do
  ...
  def test_file_field_with_direct_upload_when_rails_direct_uploads_url_is_defined
    @controller = WithProActiveStorageRoutesControllers.new

    expected = '<input data-direct-upload-url="http://testtwo.host/rails/pro_active_storage/direct_uploads" type="file" name="import[file]" id="import_file" />'
    assert_dom_equal expected, file_field("import", "file", direct_upload: true)
  end
